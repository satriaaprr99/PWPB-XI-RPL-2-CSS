                ...
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran silahkan transfer di rekening 
                        <strong>Bank BRI Nomer Rekening : 32113-821312-123</strong> 
                            dengan nominal : 
                        <strong>Rp. {{ number_format(7500+$pesanan->jumlah_harga) }}</strong></h5>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="right"><strong>Kode Unik :</strong></td>
                                <td align="right"><strong>{{ ($pesanan->kode) }}</strong></td>
                                <td colspan="3" align="right"><strong>Harga Ongkir :</strong></td>
                                <td align="right"><strong>Rp. 7,500</strong></td>
                            </tr>

                             <tr>
                                <td colspan="5" align="right"><strong>Total yang harus ditransfer :</strong></td>
                                <td align="right"><strong>Rp. {{ number_format(7500+$pesanan->jumlah_harga) }}</strong></td>
